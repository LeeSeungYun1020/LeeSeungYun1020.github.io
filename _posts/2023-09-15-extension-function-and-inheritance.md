...
excerpt: "확장 함수는 오버라이드될 수 있을까요? 상속 관계에서 확장 함수를 사용할 때의 문제점을 살펴봅니다."
---
...
하위 클래스에 확장 함수를 정의하였더라도 컬렉션을 이용할 때와 같이 상위 타입으로 참조하는 경우, 하위 클래스를 리시버로 받은 확장 함수가 호출되는 것이 보장되지 않는다.
