...
parcelRegister("2zmp9", function(module, exports) {

$parcel$export(module.exports, "fromEvent", () => $1df03abfc654dde2$export$a36e16046ae8f1bb);

var $39J5i = parcelRequire("39J5i");

var $4F4M2 = parcelRequire("4F4M2");

var $hSYiV = parcelRequire("hSYiV");

var $9MSKe = parcelRequire("9MSKe");

var $16pto = parcelRequire("16pto");

var $eJF2d = parcelRequire("eJF2d");

var $6PxSo = parcelRequire("6PxSo");
...
function $1df03abfc654dde2$export$a36e16046ae8f1bb(target, eventName, options, resultSelector) {
    if ((0, $eJF2d.isFunction)(options)) {
        resultSelector = options;
        options = undefined;
    }
    if (resultSelector) return $1df03abfc654dde2$export$a36e16046ae8f1bb(target, eventName, options).pipe((0, $6PxSo.mapOneOrManyArgs)(resultSelector));
    var _a = (0, $39J5i.__read)($1df03abfc654dde2$var$isEventTarget(target) ? $1df03abfc654dde2$var$eventTargetMethods.map(function(methodName) {
    ...
    if (!add) {
        if ((0, $16pto.isArrayLike)(target)) return (0, $9MSKe.mergeMap)(function(subTarget) {
            return $1df03abfc654dde2$export$a36e16046ae8f1bb(subTarget, eventName, options);
        })((0, $4F4M2.innerFrom)(target));
    }
    if (!add) throw new TypeError('Invalid event target');
    return new (0, $hSYiV.Observable)(function(subscriber) {
...
function $1df03abfc654dde2$var$isNodeStyleEventEmitter(target) {
    return (0, $eJF2d.isFunction)(target.addListener) && (0, $eJF2d.isFunction)(target.removeListener);
}
function $1df03abfc654dde2$var$isJQueryStyleEventEmitter(target) {
    return (0, $eJF2d.isFunction)(target.on) && (0, $eJF2d.isFunction)(target.off);
}
function $1df03abfc654dde2$var$isEventTarget(target) {
    return (0, $eJF2d.isFunction)(target.addEventListener) && (0, $eJF2d.isFunction)(target.removeEventListener);
}
...
parcelRegister("4F4M2", function(module, exports) {

$parcel$export(module.exports, "innerFrom", () => $364eb1b6adbbe903$export$6a9cfa3ebc765910);

var $39J5i = parcelRequire("39J5i");

var $16pto = parcelRequire("16pto");

var $bWQtS = parcelRequire("bWQtS");

var $hSYiV = parcelRequire("hSYiV");

var $iSo8Z = parcelRequire("iSo8Z");

var $gjQRf = parcelRequire("gjQRf");

var $bflMi = parcelRequire("bflMi");

var $egViv = parcelRequire("egViv");

var $gPGYU = parcelRequire("gPGYU");
...
function $364eb1b6adbbe903$export$6a9cfa3ebc765910(input) {
    if (input instanceof (0, $hSYiV.Observable)) return input;
    if (input != null) {
        if ((0, $iSo8Z.isInteropObservable)(input)) return $364eb1b6adbbe903$export$aa3d41784b3267fa(input);
        if ((0, $16pto.isArrayLike)(input)) return $364eb1b6adbbe903$export$4cb2acdbcda2c253(input);
        if ((0, $bWQtS.isPromise)(input)) return $364eb1b6adbbe903$export$60f45028237c39d1(input);
        if ((0, $gjQRf.isAsyncIterable)(input)) return $364eb1b6adbbe903$export$e073fccf36d78cc1(input);
        if ((0, $egViv.isIterable)(input)) return $364eb1b6adbbe903$export$dcccc29c315dd646(input);
        if ((0, $gPGYU.isReadableStreamLike)(input)) return $364eb1b6adbbe903$export$b2dcb11d46e7a4ad(input);
    }
    throw (0, $bflMi.createInvalidObservableTypeError)(input);
}
function $364eb1b6adbbe903$export$aa3d41784b3267fa(obj) {
    return new (0, $hSYiV.Observable)(function(subscriber) {
        var obs = obj[0, $6cXhT.observable]();
        if ((0, $eJF2d.isFunction)(obs.subscribe)) return obs.subscribe(subscriber);
...
function $364eb1b6adbbe903$export$60f45028237c39d1(promise) {
    return new (0, $hSYiV.Observable)(function(subscriber) {
        ...
        }).then(null, (0, $j9XA1.reportUnhandledError));
    });
}
function $364eb1b6adbbe903$export$dcccc29c315dd646(iterable) {
    return new (0, $hSYiV.Observable)(function(subscriber) {
        var e_1, _a;
        try {
            for(var iterable_1 = (0, $39J5i.__values)(iterable), iterable_1_1 = iterable_1.next(); !iterable_1_1.done; iterable_1_1 = iterable_1.next()){
...
function $364eb1b6adbbe903$export$b2dcb11d46e7a4ad(readableStream) {
    return $364eb1b6adbbe903$export$e073fccf36d78cc1((0, $gPGYU.readableStreamLikeToAsyncGenerator)(readableStream));
}
function $364eb1b6adbbe903$var$process(asyncIterable, subscriber) {
    var asyncIterable_1, asyncIterable_1_1;
    var e_2, _a;
    return (0, $39J5i.__awaiter)(this, void 0, void 0, function() {
        var value, e_2_1;
        return (0, $39J5i.__generator)(this, function(_b) {
            switch(_b.label){
                case 0:
                    _b.trys.push([
                        0,
                    ...
                    asyncIterable_1 = (0, $39J5i.__asyncValues)(asyncIterable);
                    _b.label = 1;
                case 1:
                    return [
                        4,
...
parcelRegister("16pto", function(module, exports) {

$parcel$export(module.exports, "isArrayLike", () => $0cda1c6dd59a4828$export$1e2f57719e155213);
...
parcelRegister("bWQtS", function(module, exports) {

$parcel$export(module.exports, "isPromise", () => $8b2dd2161406ec3c$export$4369c812aac99591);

var $eJF2d = parcelRequire("eJF2d");
function $8b2dd2161406ec3c$export$4369c812aac99591(value) {
    return (0, $eJF2d.isFunction)(value === null || value === void 0 ? void 0 : value.then);
}
...
parcelRegister("iSo8Z", function(module, exports) {

$parcel$export(module.exports, "isInteropObservable", () => $dbdfff9df420b143$export$48c0cddbc99c45c2);

var $6cXhT = parcelRequire("6cXhT");

var $eJF2d = parcelRequire("eJF2d");
function $dbdfff9df420b143$export$48c0cddbc99c45c2(input) {
    return (0, $eJF2d.isFunction)(input[0, $6cXhT.observable]);
}

});

parcelRegister("gjQRf", function(module, exports) {

$parcel$export(module.exports, "isAsyncIterable", () => $be176c234c83d50d$export$edb10ab8dd75a915);

var $eJF2d = parcelRequire("eJF2d");
function $be176c234c83d50d$export$edb10ab8dd75a915(obj) {
    return Symbol.asyncIterator && (0, $eJF2d.isFunction)(obj === null || obj === void 0 ? void 0 : obj[Symbol.asyncIterator]);
}

});

parcelRegister("bflMi", function(module, exports) {

$parcel$export(module.exports, "createInvalidObservableTypeError", () => $8301fd13cdffc629$export$7cbe71b9fa263484);
...
parcelRegister("egViv", function(module, exports) {

$parcel$export(module.exports, "isIterable", () => $a63f0168c5760b16$export$9652023d9040757);

var $9keU8 = parcelRequire("9keU8");

var $eJF2d = parcelRequire("eJF2d");
function $a63f0168c5760b16$export$9652023d9040757(input) {
    return (0, $eJF2d.isFunction)(input === null || input === void 0 ? void 0 : input[0, $9keU8.iterator]);
}

});
parcelRegister("9keU8", function(module, exports) {

$parcel$export(module.exports, "iterator", () => $6ca18b093ce664af$export$6f58e2338da23f4d);
...
parcelRegister("gPGYU", function(module, exports) {

$parcel$export(module.exports, "readableStreamLikeToAsyncGenerator", () => $c412bff867cdade8$export$cf4785e597badab3);
$parcel$export(module.exports, "isReadableStreamLike", () => $c412bff867cdade8$export$c088ffafdba7405f);

var $39J5i = parcelRequire("39J5i");

var $eJF2d = parcelRequire("eJF2d");
function $c412bff867cdade8$export$cf4785e597badab3(readableStream) {
    return (0, $39J5i.__asyncGenerator)(this, arguments, function readableStreamLikeToAsyncGenerator_1() {
...
function $c412bff867cdade8$export$c088ffafdba7405f(obj) {
    return (0, $eJF2d.isFunction)(obj === null || obj === void 0 ? void 0 : obj.getReader);
}

});


parcelRegister("9MSKe", function(module, exports) {

$parcel$export(module.exports, "mergeMap", () => $72030fe19283476c$export$6b9f6c0d32c093f9);

var $bn5FH = parcelRequire("bn5FH");

var $4F4M2 = parcelRequire("4F4M2");

var $dZCDm = parcelRequire("dZCDm");

var $dNya1 = parcelRequire("dNya1");

var $eJF2d = parcelRequire("eJF2d");
function $72030fe19283476c$export$6b9f6c0d32c093f9(project, resultSelector, concurrent) {
    if (concurrent === void 0) concurrent = Infinity;
    if ((0, $eJF2d.isFunction)(resultSelector)) return $72030fe19283476c$export$6b9f6c0d32c093f9(function(a, i) {
        return (0, $bn5FH.map)(function(b, ii) {
            return resultSelector(a, b, i, ii);
        })((0, $4F4M2.innerFrom)(project(a, i)));
    }, concurrent);
    else if (typeof resultSelector === 'number') concurrent = resultSelector;
    return (0, $dZCDm.operate)(function(source, subscriber) {
        return (0, $dNya1.mergeInternals)(source, subscriber, project, concurrent);
    });
}

});
parcelRegister("bn5FH", function(module, exports) {

$parcel$export(module.exports, "map", () => $84763dee3eae43dc$export$871de8747c9eaa88);

var $dZCDm = parcelRequire("dZCDm");

var $jQPy1 = parcelRequire("jQPy1");
function $84763dee3eae43dc$export$871de8747c9eaa88(project, thisArg) {
    return (0, $dZCDm.operate)(function(source, subscriber) {
        var index = 0;
        source.subscribe((0, $jQPy1.createOperatorSubscriber)(subscriber, function(value) {
...
parcelRegister("dZCDm", function(module, exports) {

$parcel$export(module.exports, "operate", () => $a2fef0bb4bf5bb57$export$871731df685d7753);

var $eJF2d = parcelRequire("eJF2d");
function $a2fef0bb4bf5bb57$export$ebec8610810318c5(source) {
    return (0, $eJF2d.isFunction)(source === null || source === void 0 ? void 0 : source.lift);
}
...
parcelRegister("jQPy1", function(module, exports) {

$parcel$export(module.exports, "createOperatorSubscriber", () => $e73adbf98bc148c1$export$b9e075132cc6937f);
...
var $e73adbf98bc148c1$export$8fbbf0c4d80268e5 = function(_super) {
    (0, $39J5i.__extends)(OperatorSubscriber, _super);
...
parcelRegister("dNya1", function(module, exports) {

$parcel$export(module.exports, "mergeInternals", () => $a0ba59950ab04705$export$600918ebaa9e0a1b);

var $4F4M2 = parcelRequire("4F4M2");

var $cjjV9 = parcelRequire("cjjV9");
...
function $a0ba59950ab04705$export$600918ebaa9e0a1b(source, subscriber, project, concurrent, onBeforeNext, expand, innerSubScheduler, additionalFinalizer) {
    ...
    var doInnerSub = function(value) {
        ...
        (0, $4F4M2.innerFrom)(project(value, index++)).subscribe((0, $jQPy1.createOperatorSubscriber)(subscriber, function(innerValue) {
            ...
            if (innerComplete) try {
                ...
                var _loop_1 = function() {
                    ...
                    if (innerSubScheduler) (0, $cjjV9.executeSchedule)(subscriber, innerSubScheduler, function() {
    ...
    source.subscribe((0, $jQPy1.createOperatorSubscriber)(subscriber, outerNext, function() {
        isComplete = true;
        checkComplete();
    }));
    return function() {
...
parcelRegister("cjjV9", function(module, exports) {

$parcel$export(module.exports, "executeSchedule", () => $8f66b637e97d9fa3$export$a2b7447487315232);
...
parcelRegister("6PxSo", function(module, exports) {

$parcel$export(module.exports, "mapOneOrManyArgs", () => $4f91c8a053ac2d08$export$559affaa48f4288d);
...
function $4f91c8a053ac2d08$var$callOrApply(fn, args) {
    return $4f91c8a053ac2d08$var$isArray(args) ? fn.apply(void 0, (0, $39J5i.__spreadArray)([], (0, $39J5i.__read)(args))) : fn(args);
}
function $4f91c8a053ac2d08$export$559affaa48f4288d(fn) {
    return (0, $bn5FH.map)(function(args) {
...
var $2zmp9 = parcelRequire("2zmp9");
var $bn5FH = parcelRequire("bn5FH");

var $h4u5t = parcelRequire("h4u5t");

var $7qU6Y = parcelRequire("7qU6Y");
const $a1d36e72aad78836$export$5d8b1d054cfb8344 = [];
(0, $2zmp9.fromEvent)(document, 'DOMContentLoaded').subscribe(()=>{
    const viewModel = new (0, $h4u5t.default)($a1d36e72aad78836$export$5d8b1d054cfb8344);
    const searchBoxElement = document.querySelector('#search_box');
    const targetElement = document.querySelector('.search-result');
    viewModel.subject.subscribe((uiState)=>{
        switch(uiState.state){
            case "initial":
                ...
                break;
            case "empty":
                targetElement.innerHTML = `<h3>"${uiState.query}"\u{C5D0} \u{B300}\u{D55C} \u{AC80}\u{C0C9} \u{ACB0}\u{ACFC}\u{B97C} \u{CC3E}\u{C744} \u{C218} \u{C5C6}\u{C5B4}\u{C694}.</h3>`;
                break;
            case "success":
                targetElement.innerHTML = uiState.results.map((post)=>$a1d36e72aad78836$var$createPostHTML(post)).join('\n');
                break;
        }
    });
    if (searchBoxElement.value.length > 0) viewModel.search(searchBoxElement.value);
    (0, $2zmp9.fromEvent)(searchBoxElement, 'input').pipe((0, $bn5FH.map)((event)=>event?.target?.value ?? "")).subscribe((query)=>{
        viewModel.search(query);
    });
});
function $a1d36e72aad78836$var$createPostHTML(post) {
    return (0, $7qU6Y.dedent)`
      <a href="${post.url}">
...
export {$a1d36e72aad78836$export$5d8b1d054cfb8344 as posts};
